...
class Request extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'there_start_date' => Yii::t('app', 'Starts at'),
            'there_end_date' => Yii::t('app', 'Ends at'),
            'travel_period_start' => Yii::t('app', 'From, days'),
            'travel_period_end' => Yii::t('app', 'To, days'),
            'status' => Yii::t('app', 'Status'),
            'mailing_processed' => Yii::t('app', 'Mail sent'),
    ...
    {
        return [
            Request::STATUS_ACTIVE => Yii::t('app', 'Active'),
            Request::STATUS_INACTIVE => Yii::t('app', 'Inactive'),
            Request::STATUS_DELETED => Yii::t('app', 'Deleted'),
            Request::STATUS_OUTDATE => Yii::t('app', 'Outdated'),
        ];
    }

    public function getStatusName()
    {
        return (isset(Request::getStatusArray()[$this->status])? Request::getStatusArray()[$this->status]: Yii::t('app', 'Wrong status'));
    }
    ...
    public function getStatusBadge()
    {
        switch ($this->status) {
            case Request::STATUS_ACTIVE:
                $statusBadgeClass = 'label-success';
                break;
            case Request::STATUS_INACTIVE:
                $statusBadgeClass = 'label-info';
                break;
            case Request::STATUS_DELETED:
                $statusBadgeClass = 'label-danger';
                break;
            case Request::STATUS_OUTDATE:
                $statusBadgeClass = 'label-default';
                break;
            default:
                $statusBadgeClass = 'label-default';
        }
